...
def test_full_combat_round():
    ...
    assert enemy.health == 125, "Enemy should take reduced damage"
    assert enemy.aggro["Tank"] == 50, "Tank should generate aggro"
    ...
    assert enemy.health == 90, "Enemy should take mixed damage"
    assert enemy.aggro["DPS"] == 50, "DPS should generate aggro"
...
def test_input_parsing():
    ...
    assert healing_dict == {"h": 40, "t": 20}, "Should parse mixed healing"
